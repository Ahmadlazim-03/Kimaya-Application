      ...
      <div className="flex items-center gap-2">
            ...
            {showNotif && (
              ...
              >
                <div className="px-4 py-3 border-b border-kimaya-cream-dark/20 flex items-center justify-between">
                  ...
                  <span className="text-xs bg-kimaya-olive/10 text-kimaya-olive px-2 py-0.5 rounded-full font-medium">
                ...
                <div className="px-4 py-2.5 border-t border-kimaya-cream-dark/20 text-center">
                  <button className="text-xs text-kimaya-olive font-medium hover:text-kimaya-olive-dark transition-colors">
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <span className="hidden sm:inline text-sm font-medium text-kimaya-brown">Admin</span>
          ...
          <AnimatePresence>
            {showProfile && (
              <motion.div
                ...
                animate="visible"
                exit="exit"
                className="absolute right-0 top-13 w-56 bg-white rounded-2xl shadow-xl shadow-black/8 border border-kimaya-cream-dark/30 overflow-hidden z-50"
              >
                <div className="px-4 py-3 border-b border-kimaya-cream-dark/20">
                  <p className="font-semibold text-sm text-kimaya-brown">Admin HR</p>
                  <p className="text-xs text-kimaya-brown-light/50">admin@kimayaexperience.com</p>
                </div>
                <div className="py-1">
                ...
                <div className="border-t border-kimaya-cream-dark/20 py-1">
                  <a href="/login" className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-red-500 hover:bg-red-50 transition-colors">
